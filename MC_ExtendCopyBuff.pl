...
/execute STR_SELECT_PLAYERS ~X_PLAYER_START ~Y_PLAYER_START ~Z_PLAYER_START /execute @e[STR_SELECT_CONTROL_BUFFER_COND] ~ ~ ~ /execute @e[STR_SELECT_COPY_BUFFER_COND] ~X_CHECK_POS ~Y_CHECK_POS ~Z_CHECK_POS /scoreboard players set @e[STR_SELECT_COPY_BUFFER_COND,dx=0,dy=0,dz=0] V_ExtndConflict 1

/execute STR_SELECT_PLAYERS ~X_PLAYER_START ~Y_PLAYER_START ~Z_PLAYER_START /execute @e[STR_SELECT_CONTROL_BUFFER_COND] ~ ~ ~ /execute @e[STR_SELECT_COPY_BUFFER_FRAME_COND] ~X_CHECK_POS ~Y_CHECK_POS ~Z_CHECK_POS /scoreboard players set @e[STR_SELECT_COPY_BUFFER_COND,dx=0,dy=0,dz=0] V_ExtndConflict 1

/execute STR_SELECT_PLAYERS ~X_PLAYER_START ~Y_PLAYER_START ~Z_PLAYER_START /execute @e[STR_SELECT_CONTROL_BUFFER_COND] ~ ~ ~ /execute @e[STR_SELECT_COPY_BUFFER_COND,score_V_ExtndConflict=0] ~ ~ ~ /summon ItemFrame ~X_SET_POS ~Y_SET_POS ~Z_SET_POS {Invulnerable:1b,Invisible:1b,NoGravity:1b,CustomName:"COPY_BUFF_FRAME",CustomNameVisible:true,PersistenceRequired:0b}
