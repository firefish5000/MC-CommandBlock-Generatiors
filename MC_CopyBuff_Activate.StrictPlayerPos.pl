...
STR_SELECT_CONTROL_BUFFER_COND:='score_T_ContBuff_min=1,score_V_Itter=MAX_ITTERATIONS,dx=X_BUFF_END,dy=Y_BUFF_END,dz=Z_BUFF_END,c=1'
STR_SELECT_CONTROL_BUFFER_OVERITTER_COND:='score_T_ContBuff_min=1,score_V_Itter_min=OVER_MAX_ITTERATIONS,dx=X_BUFF_END,dy=Y_BUFF_END,dz=Z_BUFF_END,c=1'
...
-----
### Pre Checks
/execute STR_SELECT_PLAYERS ~X_PLAYER_START ~Y_PLAYER_START ~Z_PLAYER_START /testfor @e[STR_SELECT_CONTROL_BUFFER_COND,score_V_CopyWait=0]
...
/execute STR_SELECT_PLAYERS ~X_PLAYER_START ~Y_PLAYER_START ~Z_PLAYER_START /scoreboard players add @e[STR_SELECT_CONTROL_BUFFER_COND] V_Itter 1
/execute STR_SELECT_PLAYERS ~X_PLAYER_START ~Y_PLAYER_START ~Z_PLAYER_START /execute @e[STR_SELECT_CONTROL_BUFFER_OVERITTER_COND] ~ ~ ~ /tell STR_SELECT_PLAYERS CONTROL BUFFER has surpassed its MAX_ITTERATIONS itteration limit, and we failed to copy some buffers.

/execute STR_SELECT_PLAYERS ~X_PLAYER_START ~Y_PLAYER_START ~Z_PLAYER_START /execute @e[STR_SELECT_CONTROL_BUFFER_COND] ~ ~ ~ /execute @e[STR_SELECT_COPY_BUFFER_COND,score_V_Copied=0] ~X_CHECK_POS ~Y_CHECK_POS ~Z_CHECK_POS /scoreboard players set @e[STR_SELECT_COPY_BUFFER_COND,score_V_Copied=0,dx=0,dy=0,dz=0] V_OverlapWait 1

### Clone and TP unmarked buffers
/execute STR_SELECT_PLAYERS ~X_PLAYER_START ~Y_PLAYER_START ~Z_PLAYER_START /execute @e[STR_SELECT_CONTROL_BUFFER_COND] ~ ~ ~ /execute @e[STR_SELECT_COPY_BUFFER_COND,score_V_OverlapWait=0,score_V_Copied=0] ~ ~ ~ /clone ~ ~ ~ ~ ~ ~ ~X_SET_POS ~Y_SET_POS ~Z_SET_POS

/execute STR_SELECT_PLAYERS ~X_PLAYER_START ~Y_PLAYER_START ~Z_PLAYER_START /execute @e[STR_SELECT_CONTROL_BUFFER_COND] ~ ~ ~ /tp @e[STR_SELECT_COPY_BUFFER_COND,score_V_OverlapWait=0,score_V_Copied=0,score_V_CopyBuffTP_min=1] ~X_SET_POS ~Y_SET_POS ~Z_SET_POS

### Mark Cloned buffers as proccessed, and clear flags on uncloned ones.
/execute STR_SELECT_PLAYERS ~X_PLAYER_START ~Y_PLAYER_START ~Z_PLAYER_START /execute @e[STR_SELECT_CONTROL_BUFFER_COND] ~ ~ ~ /scoreboard players set @e[STR_SELECT_COPY_BUFFER_COND,score_V_OverlapWait=0,score_V_Copied=0] V_Copied 1

#/scoreboard players set @e[STR_SELECT_COPY_BUFFER_COND] V_OverlapWait 0

# Test If we Loop or finish
/execute STR_SELECT_PLAYERS ~X_PLAYER_START ~Y_PLAYER_START ~Z_PLAYER_START /execute @e[STR_SELECT_CONTROL_BUFFER_COND] ~ ~ ~ /testfor @e[STR_SELECT_COPY_BUFFER_COND,score_V_Copied=0]
# If Loop Next
/setblock ~ ~ ~-8 minecraft:command_block 3 replace {auto:1b}
/testforblock ~ ~ ~-2 minecraft:chain_command_block 3 {conditionMet:1b,SuccessCount:0}
# If Finish Next
/setblock ~ ~ ~2 minecraft:command_block 3 replace {auto:1b}

# Remove OverlapWait Before Loop on Next Tick
/execute STR_SELECT_PLAYERS ~X_PLAYER_START ~Y_PLAYER_START ~Z_PLAYER_START /execute @e[STR_SELECT_CONTROL_BUFFER_COND] ~ ~ ~ /scoreboard players set @e[STR_SELECT_COPY_BUFFER_COND] V_OverlapWait 0
...
/execute STR_SELECT_PLAYERS ~X_PLAYER_START ~Y_PLAYER_START ~Z_PLAYER_START /scoreboard players set @e[STR_SELECT_CONTROL_BUFFER_COND] V_Itter 0
...
#/execute STR_SELECT_PLAYERS ~X_PLAYER_START ~Y_PLAYER_START ~Z_PLAYER_START /execute @e[STR_SELECT_CONTROL_BUFFER_COND] ~ ~ ~ /scoreboard players set @e[STR_SELECT_COPY_BUFFER_COND,score_V_Copied_min=1] V_Copied 0
